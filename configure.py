    ...
    GameLib(
        ...
        [
            ...
            *[
            ...
            Object(
                Matching,
                "game/gs_range_exact_801C766C.c",
                mw_version="GC/1.3",
                extra_cflags=["-use_lmw_stmw on", "-sdata 8", "-sdata2 8"],
                progress_category="game",
            ),
            Object(
                CodeCandidate,
                "game/gs_range_candidate_801C7730.c",
                mw_version="GC/1.3",
                extra_cflags=["-use_lmw_stmw on", "-sdata 8", "-sdata2 8"],
                progress_category="game",
            ),
            Object(
                Matching,
                "game/gs_range_exact_801C84FC.c",
                mw_version="GC/1.3",
                extra_cflags=["-use_lmw_stmw on", "-sdata 8", "-sdata2 8"],
                progress_category="game",
            ),
            Object(
                CodeCandidate,
                "game/gs_range_candidate_801C8688.c",
                mw_version="GC/1.3",
                extra_cflags=["-use_lmw_stmw on", "-sdata 8", "-sdata2 8"],
                progress_category="game",
            ),
            Object(
                Matching,
                "game/gs_range_exact_801C8804.c",
                mw_version="GC/1.3",
                extra_cflags=["-use_lmw_stmw on", "-sdata 8", "-sdata2 8"],
                progress_category="game",
            ),
            Object(
                CodeCandidate,
                "game/gs_range_candidate_801C8834.c",
                mw_version="GC/1.3",
                extra_cflags=["-use_lmw_stmw on", "-sdata 8", "-sdata2 8"],
                progress_category="game",
            ),
