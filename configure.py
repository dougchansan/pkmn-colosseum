...
# Undeclared units link the dtk-extracted (asm) object as-is, reproducing the
# original DOL. Matching C objects are declared here and substituted in. The
# migration populates this incrementally; an empty list yields the all-asm
# byte-match baseline.
