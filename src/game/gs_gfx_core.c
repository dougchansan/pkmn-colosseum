 ...
 *
 * XD source unit: game/pxdvs/GSAPI/GSgfxM/GSgfx.cpp
 * Address range: 0x800D3E4C - 0x800D3FA4 (4 functions)
 *
 * XD GSgfx.cpp = {RelocToScratch 0x48, Shutdown 0x24, Init 0xE0, _gfxScratchNotify 0x78}. Ours: Notify(0x78 exact) + fn_800D3EC4(0x8C~Init) + fn_800D3F50(0xC~Shutdown) + fn_800D3F5C(0x48 EXACT match RelocToScratch). Colosseum placed Notify first; same 4-function TU. Single anchor -> trivially monotonic.
 *
...
/* ==================================================================
 * _gfxScratchNotify__F15GSscratchNotifyPvUc -- GSgfx VBlank callback
 *
