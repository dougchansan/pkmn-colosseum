...
s32 fn_8001329C(u8* ctx, u8* tgt) {
    ...
    case 0x92:
        if (*(s32*)(ctx + 4) == 0x107) {
            fn_8001E644(0, 0, *(s16*)(tgt + 0x54), *(s16*)(tgt + 0x56), ctx[0x8B]);
        } else {
            fn_8001EC08(0, 0, *(s16*)(tgt + 0x54), *(s16*)(tgt + 0x56), ctx[0x8B], 1);
        }
        break;
    case 0x93:
        value = *(s16*)(data + 2);
...
typedef struct EventConfirmArg {
    u8 bytes[3];
    u8 pad;
    s32* values;
    s32 mode;
...
s32 fn_80013A18(s32 entry_idx, s32 target_n, s32* out) {
    ...
    values[3] = lbl_80266BD8[3];
    values[4] = lbl_80266BD8[4];
...
s32 fn_80014574(u8* ctx) {
    ...
    if ((bits & 1) != 0) {
        ...
        if (min_value != max_value) {
            if (place < 10) {
                value = (s32)lbl_8047A2FC + place;
                lbl_8047A2FC = value;
                if (value > max_value) {
                    lbl_8047A2FC = min_value;
                }
                fn_80166A50(0x23, 0, 0xFF, 0);
            } else {
                current = lbl_8047A2FC;
                digit = (current / place) % 10;
