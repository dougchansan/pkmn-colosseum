...
/* =======================================================================
 *  GStextureGetGXformat | 0xF4
 *  TODO: match -- gs_render.c calls GStextureGetGXformat(image, 1) expecting a
...
/* =======================================================================
 *  GStextureGetFormat | 0x8
 *  TODO: match -- gs_render.c calls GStextureGetFormat() with zero args and
