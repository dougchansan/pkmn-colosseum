...
|---|---|
| Fuzzy match | 57.39% |
| Function match | 72.75% (6,259 / 8,603 functions) |
| Code match | 35.48% (885,176 / 2,495,108 matched code bytes) |
| Data match | 97.29% (2,136,502 / 2,196,121 matched data bytes) |
| Linked into DOL | 341 / 770 units (14.60% of code) |
