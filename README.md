...
**Pokémon Colosseum is 83.38% decompiled**

**0.55% fully linked**

| Segment | Matched | Fully linked | Detail |
|---|---:|---:|---|
| Code (1.37 MB) | `[##########--------------]` 39.79% | `[------------------------]` 1.42% | 544,556 / 1,368,604 matched bytes; 4,356 / 6,795 functions (64.11%) |
| Data (2.20 MB) | `[########################]` 100.00% | `[------------------------]` 0.00% | 2,196,287 / 2,196,287 matched bytes |

Last measured 2026-06-27 with `python tools/gen_decomp_report.py -o report.json`.
