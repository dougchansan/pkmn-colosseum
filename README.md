...
|---|---|
| Fuzzy match | 57.39% |
| Function match | 72.77% (6,260 / 8,603 functions) |
| Code match | 35.48% (885,224 / 2,495,108 matched code bytes) |
| Data match | 97.29% (2,136,497 / 2,196,116 matched data bytes) |
| Linked into DOL | 373 / 811 units (15.87% of code) |
