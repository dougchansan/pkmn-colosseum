...
|---|---|
| Fuzzy match | 57.41% |
| Function match | 72.86% (6,268 / 8,603 functions) |
| Code match | 35.53% (886,496 / 2,495,108 matched code bytes) |
| Data match | 97.28% (2,136,457 / 2,196,108 matched data bytes) |
| Linked into DOL | 543 / 1,049 units (19.84% of code) |
